...
function createTheme(colors: Colors) {
  ...
  return {
    ...
    colors: {
      ...
      "terminal.ansiWhite": colors.ansi.normal.white,
      "terminal.ansiBrightWhite": colors.ansi.bright.white,
      "terminal.ansiBlack": colors.ansi.normal.black,
      "terminal.ansiBrightBlack": colors.ansi.bright.black,
      "terminal.ansiBlue": colors.ansi.normal.blue,
      "terminal.ansiBrightBlue": colors.ansi.bright.blue,
      "terminal.ansiCyan": colors.ansi.normal.cyan,
      "terminal.ansiBrightCyan": colors.ansi.bright.cyan,
      "terminal.ansiGreen": colors.ansi.normal.green,
      "terminal.ansiBrightGreen": colors.ansi.bright.green,
      "terminal.ansiRed": colors.ansi.normal.red,
      "terminal.ansiBrightRed": colors.ansi.bright.red,
      "terminal.ansiMagenta": colors.ansi.normal.magenta,
      "terminal.ansiBrightMagenta": colors.ansi.bright.magenta,
      "terminal.ansiYellow": colors.ansi.normal.yellow,
      "terminal.ansiBrightYellow": colors.ansi.bright.yellow,
