...
export const generate: ThemeGenerator = async ({
  ...
  await ensureDir(path.join(outputDirectory, "./resources"));

  // Create UI theme
  await fsPromises.writeFile(
    path.join(outputDirectory, "./resources/concrete.theme.json"),
    createUiTheme(colors)
  );

  //  Create syntax theme
  await fsPromises.writeFile(
    path.join(outputDirectory, "./resources/concrete.xml"),
  ...
  return JSON.stringify(
    {
      ...
      ui: {
        "*": {
          ...
          selectionBackground: {
            "os.default": colors.background.activeSelection,
            "os.windows": colors.background.activeSelection,
            "os.mac": colors.background.activeSelection,
          },
          selectionForeground: {
            "os.default": colors.neutral[840],
            "os.windows": colors.neutral[840],
            "os.mac": colors.neutral[840],
          },
...
function createSyntaxTheme(colors: Colors) {
  return `
<scheme name="Concrete" version="142" parent_scheme="Darcula">
  <metaInfo>
    <property name="ide">idea</property>
    <property name="ideVersion">2024.1.4.0.0</property>
    <property name="originalScheme">Concrete</property>
  </metaInfo>
  <colors>
  ...
  <attributes>
    ...
    <option name="DEFAULT_BRACES" baseAttributes="" />
    <option name="DEFAULT_BRACKETS" baseAttributes="" />
    ...
    <option name="DEFAULT_DOT" baseAttributes="" />
    ...
    <option name="DEFAULT_INVALID_STRING_ESCAPE" baseAttributes="" />
    ...
    <option name="DEFAULT_PARENTHS" baseAttributes="" />
    ...
    <option name="HAML_TAG" baseAttributes="" />
